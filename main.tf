...
# NOTE: hosted_zone and certificate_manager modules are disabled.
# They require the domain "jhooq.org" to be registered in Route53.
# To enable HTTPS later:
#   1. Register your domain in Route53 (or delegate an existing domain)
#   2. Uncomment the modules below and set your domain name in terraform.tfvars
